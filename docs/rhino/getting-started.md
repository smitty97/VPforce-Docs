...
When you connect the **Rhino** to your computer for the first time, a popup should appear with a link to the **VPforce WebUSB Tool**. If you miss the popup, you can visit the site directly: [*https://vpforce.eu/usb/rhino/*](https://vpforce.eu/usb/rhino/).
...
Go to [https://vpforce.eu/usb/rhino/](https://vpforce.eu/usb/rhino/) and download the latest **Rhino Desktop Software package**. While older versions are available, it's recommended to use the latest release. The software comes as a simple ZIP file - unpack it to a folder of your choice.\ To start the configurator, double-click **"VPforce_FFB_Configurator.exe"** inside the folder.

2. **Verify Connection**  
Once open, you should see values like **raw_x** and **raw_y** react as you move the stick, along with **curr_x**, **curr_y**, and other parameters. If nothing appears:
